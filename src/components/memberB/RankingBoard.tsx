            ...
            return (
              <li
                ...
                className={`text-sm flex items-center justify-between p-2 rounded-lg ${
                  isTop
                    ? "bg-amber-100/50 font-semibold text-amber-950"
                    : "text-slate-700"
                }`}
              >
                <div>
                  <span
                    className={`inline-block w-6 text-center ${isTop ? "text-amber-600 font-extrabold" : "text-slate-400"}`}
                  >
                    {index + 1}위
                  </span>
